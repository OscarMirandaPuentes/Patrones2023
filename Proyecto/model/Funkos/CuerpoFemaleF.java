...
//Coordenadas Cuerpo
	...
	private CuerpoFemaleF(CuerpoFemaleF cuerpoFemaleF) {
		this.x = cuerpoFemaleF.x;
		this.y = cuerpoFemaleF.y;
		this.h = cuerpoFemaleF.h;
		this.w = cuerpoFemaleF.w;
		this.colorH = Color.pink;
		this.ProductoInfo = new HashMap<>();
		llenarHm();
	}
